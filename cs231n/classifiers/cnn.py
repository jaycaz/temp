...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    activation_map_size = num_filters * input_dim[1] / 2 * input_dim[2] / 2

    self.params['W1'] = np.random.normal(0.0, weight_scale, conv_shape)
    self.params['b1'] = np.zeros(num_filters,)
    self.params['W2'] = np.random.normal(0.0, weight_scale, (activation_map_size, hidden_dim))
  ...
  def loss(self, X, y=None):
    ...
    dh2, grads['W3'], grads['b3'] = affine_backward(dloss, cache3)
